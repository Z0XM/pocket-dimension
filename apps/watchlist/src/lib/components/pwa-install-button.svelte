...
{#if canInstall || showIosHint}
  <button
    type="button"
    class="fixed right-4 bottom-4 z-50 rounded-full border border-border/80 bg-background/90 px-3 py-1.5 text-xs font-medium text-foreground shadow-md backdrop-blur transition-colors hover:bg-accent/70"
