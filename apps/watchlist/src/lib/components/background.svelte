...
<div class="background-container">
  <svg
    ...
    class="background-svg {enableFilter ? 'filter-enabled' : ''} {enableAnimation ? '' : 'no-animation'}"
  ...
  >
    ...
    <defs>
      ...
      >
        ...
        <feTurbulence id="turbulence-filter" type="fractalNoise" baseFrequency="0.1190476268529892 0.1190476268529892" numOctaves="3" seed="2977" />
        <feDisplacementMap
