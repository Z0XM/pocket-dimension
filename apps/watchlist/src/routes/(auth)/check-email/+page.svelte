...
<div class="p-6 md:p-8">
  <div class="flex flex-col items-center gap-6 text-center">
    <div class="flex h-16 w-16 items-center justify-center rounded-full bg-accent/30">
    ...
    {#if resendSuccess}
      <div class="rounded-md bg-green-500/15 p-3 text-sm text-green-700 dark:text-green-400 w-full">Verification email sent successfully!</div>
    {/if}
