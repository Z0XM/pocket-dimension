# zeo production deployment (Hostinger KVM 2)

Runbook for deploying zeo with LiveKit, Caddy TLS, and PostgreSQL on a single VPS.
...
```bash
sudo bash deploy/firewall/ufw-rules.example.sh
```
...
| Path | Purpose |
|------|---------|
| [caddy/](./caddy/) | Caddyfile + TLS docs (Story 6.1) |
| [livekit/](./livekit/) | Dev + production LiveKit compose |
| [firewall/](./firewall/) | ufw checklist (Story 6.2) |
| [coturn/](./coturn/) | Optional external TURN |
| [env/](./env/) | Production env template (Story 6.3) |
| [systemd/](./systemd/) | zeo systemd unit |
