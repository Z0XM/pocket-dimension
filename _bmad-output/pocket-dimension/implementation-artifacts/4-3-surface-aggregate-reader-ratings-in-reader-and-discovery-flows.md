...
- The architecture already names `reader_average_rating` and `reader_rating_count` as part of the target piece model. Use that as the baseline. [Source: `_bmad-output/pocket-dimension/planning-artifacts/architecture.md`]
...
- This story depends on both creator ratings (Story 4.1) and user ratings (Story 4.2). [Source: `_bmad-output/pocket-dimension/implementation-artifacts/4-1-capture-and-display-creator-ratings.md`, `_bmad-output/pocket-dimension/implementation-artifacts/4-2-allow-any-logged-in-user-to-rate-and-update-ratings.md`]
...
- `_bmad-output/pocket-dimension/implementation-artifacts/4-1-capture-and-display-creator-ratings.md`
- `_bmad-output/pocket-dimension/implementation-artifacts/4-2-allow-any-logged-in-user-to-rate-and-update-ratings.md`
