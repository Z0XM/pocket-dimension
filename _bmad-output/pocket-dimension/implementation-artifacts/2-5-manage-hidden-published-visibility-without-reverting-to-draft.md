...
- Ratings and revision/history stories come later, but hiding/unhiding must not discard those future-linked records or timestamps. [Source: `_bmad-output/pocket-dimension/planning-artifacts/epics.md`, `_bmad-output/pocket-dimension/planning-artifacts/architecture.md`]
...
- `_bmad-output/pocket-dimension/implementation-artifacts/2-3-expose-direct-publish-action-beside-save.md`
