...
- The architecture already calls out revision history and auditability as first-class requirements. This story should create the durable foundation rather than a throwaway debug log. [Source: `_bmad-output/pocket-dimension/planning-artifacts/architecture.md`, `_bmad-output/pocket-dimension/planning-artifacts/prds/prd-rhymes-revamp-2026-06-20/prd.md`]
...
- This story is cross-cutting: it should align with Epic 2 publish/hide flows, Epic 4 rating updates, and Epic 5 permission changes. [Source: `_bmad-output/pocket-dimension/planning-artifacts/epics.md`]
