...
- Creator rating is its own field on the piece model and must not be conflated with community aggregates. [Source: `_bmad-output/rhymes/planning-artifacts/architecture.md`, `_bmad-output/rhymes/planning-artifacts/epics.md`]
