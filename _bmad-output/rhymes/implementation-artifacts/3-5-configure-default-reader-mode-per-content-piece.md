...
- Product rules explicitly say default reader mode is configured per content piece, not rigidly by content type. Preserve that distinction in naming and validation. [Source: `_bmad-output/rhymes/project-context.md`, `_bmad-output/rhymes/planning-artifacts/prds/prd-rhymes-revamp-2026-06-20/prd.md`]
